...
return [
    ...
    'greeting'          =>
        '<p>Γεια σας! Καλωσορίσατε στο κέντρο βοήθειας. Εδώ μπορείτε να βρείτε απαντήσεις σε συχνές ερωτήσεις.<p>
        ...
        'account'       => [
            ...
            'article'   => [
                'not-activated'    => [
                    ...
                    'body'         =>
                        '<p>Εάν δεν έχετε ενεργοποιήσει τον λογαριασμό σας, η σύνδεσή σας σε αυτόν είναι αδύνατη. Αυτό συμβαίνει επειδή πρέπει να επαληθεύσετε πως έχετε πρόσβαση στην διεύθυνση email που παρείχατε κατά την εγγραφή.</p>
        ...
        'profile'       => [
            ...
            'article'   => [
                'customize'     => [
                    ...
                    'body'      =>
                        '<p>Πατήστε <strong>' . (auth()->check() ? auth()->user()->fullName() : 'στο όνομά σας') . '</strong> στη μπάρα περιήγησης από πάνω για να επισκεφθείτε το προφίλ σας.</p>
