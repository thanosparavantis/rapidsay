        ...
        'account' => [
            ...
            'article' => [
                'not-activated' => [
                    ...
                    'body'          => '<p>If your account is not activated, you will not be able to login successfully. That\'s because you need to verify that you have access to the email address you supplied during registration.</p>
                ...
                'forgot-password' => [
                    ...
                    'body'          => '<p>You have the option to request a password reset <a href="' . route("password-reset") . '">here</a>. Once you fill in your email address, an email will be sent with a link that leads to the password reset page. There you can select a new password and then login with the new one.</p>
                ...
                'blocked' => [
                    ...
                    'body'          => '<p>Unfortunate, a blocked account can no longer be accessed. This may have happened, because the user that controls this account has violated one of our <a href="' . route('terms-of-use') . '">' . trans('about.terms-of-use') . '</a>. Usually, this action cannot be revoked, unless the account ban was placed by accident.</p>
        ...
        'profile' => [
            ...
            'article' => [
                'customize' => [
                    ...
                    'body'          => '<p>Click on <strong>' . (auth()->check() ? auth()->user()->fullName() : 'your name') . '</strong> in the navigation bar above to visit your profile.</p>
                ...
                'placement' => [
                    ...
                    'body'          => '<p>Placement is displayed with the <i class="fa fa-' . config('glyphicons.placement') . '" aria-hidden="true"></i> icon and represents your current position in the community list.</p>
                                        <p>You may increase your reputation in order to gain a higher position.</p>',
                ],

                'reputation' => [
                    'title'         => 'What is my reputation?',
                    'body'          => '<p>Reputation is displayed with the <i class="fa fa-' . config('glyphicons.reputation') . '" aria-hidden="true"></i> icon and represents the amount of ratings others have given to your posts.</p>
        ...
        'activity' => [
            ...
            'article' => [
                'all' => [
                    ...
                    'body'          => '<p>Your activity consists of all your posts, comments and ratings. To visit your profile, click <strong>' . (auth()->check() ? auth()->user()->fullName() : 'on your name') . '</strong> in the navigation bar above.</p>
                ...
                'create' => [
                    ...
                    'body'          => '<p>To create a new post, click the <strong><i class="fa fa-home" aria-hidden="true"></i> ' . trans('page.title.home') . '</strong> link in the navigation bar above.</p>
                ...
                'comment' => [
                    ...
                    'body'          => '<p>To comment on a post, click on the <strong>' . trans('comment.button.comment') . '</strong> button below the preview. You will be redirected to the post page, where the comment form will be visible.</p>
                ...
                'image' => [
                    ...
                    'body'          => '<p>You can upload images by clicking the <i class="fa fa-' . config('glyphicons.image') . '" aria-hidden="true"></i> icon under every form.</p>
                ...
                'format' => [
                    ...
                    'body'          => '<p>The following formatting rules are currently available:</p>
                                        <ul>
        ...
        'notifications' => [
            ...
            'article' => [
                'view' => [
                    ...
                    'body'          => '<p>To view the list of notifications, click the <i class="fa fa-' . config('glyphicons.notification') . '" aria-hidden="true"></i> icon in the navigation bar above.</p>',
                ],

                'interact' => [
                    'title'         => 'How do I know if someone interacted with my content?',
                    'body'          => '<p>When someone interacts with your content or profile, you will receive a notification. The number of unread notifications will appear near the <i class="fa fa-' . config('glyphicons.notification') . '" aria-hidden="true"></i> icon. If one or more notifications refer to deleted content, they will be removed automatically.</p>
