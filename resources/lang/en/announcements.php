...
return [
    ...
    'new-dashboard'         => 'Check out the new user dashboard by clicking the <i class="fa fa-' .  config('glyphicons.dashboard') . '" aria-hidden="true"></i> icon in the navigation bar above.',
];
